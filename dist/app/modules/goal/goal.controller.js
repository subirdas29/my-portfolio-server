...
const getAllGoalsController = (0, catchAsync_1.default)(async (req, res) => { const r = await goal_service_1.GoalServices.getAllGoals(req.query); (0, sendResponse_1.default)(res, { statusCode: http_status_1.default.OK, success: true, message: 'Goals fetched', data: r }); });
