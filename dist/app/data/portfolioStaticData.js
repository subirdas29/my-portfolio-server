...
exports.buildAboutMeContext = exports.buildEducationContext = exports.buildExperienceContext = exports.ABOUT_ME_DATA = exports.EDUCATION_DATA = exports.EXPERIENCE_DATA = void 0;
exports.EXPERIENCE_DATA = [
    {
...
const buildExperienceContext = () => {
    return exports.EXPERIENCE_DATA.map((exp, i) => `EXPERIENCE ${i + 1}: ${exp.title} at ${exp.company} (${exp.duration}). Description: ${exp.description}`).join('\n');
};
exports.buildExperienceContext = buildExperienceContext;
const buildEducationContext = () => {
    return exports.EDUCATION_DATA.map((edu, i) => `EDUCATION ${i + 1}: ${edu.degree} from ${edu.institution} (${edu.duration}). ${edu.description}`).join('\n');
};
exports.buildEducationContext = buildEducationContext;
const buildAboutMeContext = () => {
