...
exports.buildJobExperienceResponse = buildJobExperienceResponse;
const buildExperienceDurationResponse = (siteUrl) => `Subir has **5+ years of hands-on experience** in software development — from academic projects during B.Sc. in CSE at Faridpur Engineering College to his current role as a **Junior Software Engineer at Codealign**, building full-stack applications and AI-powered solutions.

---
Want to discuss your project? **Let's connect!**

${(0, aiChatDetection_1.getContactMessage)(siteUrl)}`;
exports.buildExperienceDurationResponse = buildExperienceDurationResponse;
const buildFreelancingResponse = (siteUrl) => `Subir is available on **Fiverr and Upwork** for custom projects. He focuses on AI solutions, scalable web applications, and MVPs for startups worldwide.
...
${(0, aiChatDetection_1.getContactMessage)(siteUrl)}`;
exports.buildFreelancingResponse = buildFreelancingResponse;
const buildCapabilityResponse = (what, siteUrl) => `**Absolutely!** Subir specializes in building ${what}. With expertise in **Next.js, Node.js, AI Agents (n8n, Gemini), and workflow automation**, he can architect and deliver a production-ready solution tailored to your needs.
...
${(0, aiChatDetection_1.getContactMessage)(siteUrl)}`;
exports.buildCapabilityResponse = buildCapabilityResponse;
const buildNegativeFallbackResponse = (siteUrl) => `I don't have that specific information in my current data, but here's what I can tell you:
