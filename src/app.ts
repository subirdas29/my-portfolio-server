...
// Health check route — placed BEFORE all middleware so it returns instantly with
// zero DB/AI/token overhead. Used by Cron Job / UptimeRobot to ping every ~5 min
// to keep the Render Free Tier instance 'warm' and prevent the 15-minute sleep mode.
