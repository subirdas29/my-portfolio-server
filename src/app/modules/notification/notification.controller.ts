...
const markAsReadController = catchAsync(async (req, res) => { const r = await NotificationServices.markAsRead(req.params.id as string); sendResponse(res, { statusCode: httpStatus.OK, success: true, message: 'Marked as read', data: r }); });
...
const deleteNotificationController = catchAsync(async (req, res) => { await NotificationServices.deleteNotification(req.params.id as string); sendResponse(res, { statusCode: httpStatus.OK, success: true, message: 'Notification deleted', data: null }); });
