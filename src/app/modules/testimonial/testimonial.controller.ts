...
const updateTestimonialController = catchAsync(async (req, res) => { const r = await TestimonialServices.updateTestimonial(req.params.id, req.body); sendResponse(res, { statusCode: httpStatus.OK, success: true, message: 'Testimonial updated', data: r }); });
const deleteTestimonialController = catchAsync(async (req, res) => { await TestimonialServices.deleteTestimonial(req.params.id); sendResponse(res, { statusCode: httpStatus.OK, success: true, message: 'Testimonial deleted', data: null }); });
const toggleFeaturedController = catchAsync(async (req, res) => { const r = await TestimonialServices.toggleFeatured(req.params.id); sendResponse(res, { statusCode: httpStatus.OK, success: true, message: 'Featured toggled', data: r }); });
