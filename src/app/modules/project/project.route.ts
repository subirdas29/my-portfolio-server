...
import * as ProjectModelModule from './project.model';
...
router.post('/', validateRequest(ProjectValidation.projectSchema), ProjectController.createProjectController);
...
router.patch('/edit-project/:id', validateRequest(ProjectValidation.updateProjectSchema), ProjectController.updateOwnProjectController);
router.patch('/reorder', ProjectController.updateProjectOrderController);
router.delete('/:id', ProjectController.deleteOwnProjectController);
