...
export const extractCapabilityWhat = (message: string): string => {
  ...
  if (lower.includes('agent') || lower.includes('bot')) return 'AI agents and bots';
  if (lower.includes('web') || lower.includes('website') || lower.includes('app'))
    return 'web applications';
  if (lower.includes('messenger') || lower.includes('chat')) return 'messenger/chat bots';
  if (
  ...
  if (lower.includes('mvp') || lower.includes('startup')) return 'MVPs for startups';
  return 'your project';
};
